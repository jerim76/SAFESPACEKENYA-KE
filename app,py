...
services = [
    ...
    ("🧠", "Gender & Identity Counseling", "Support for individuals exploring gender identity and sexual orientation."),
    ("📿", "Addiction Recovery Support", "Structured therapy for alcohol, drug, or behavioral addiction recovery."),
    ("🕊️", "Grief & Loss Counseling", "Empathetic guidance through mourning and personal loss."),
...
teams = [
    ...
    {"name": "Hamdi Roble", "role": "Co-Founder & Senior Therapist", "bio": "Muslim therapist specializing in culturally-sensitive CBT for anxiety and depression.",

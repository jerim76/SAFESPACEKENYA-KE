...
knowledge_base = [
    ...
    {"question": r"what services do you offer\??", "answer": "We offer Individual Counseling for personal issues, Group Therapy for community support, Family Counseling for family dynamics, and Trauma Recovery Therapy for survivors, using methods like CBT, EMDR, and mindfulness."},
    ...
    {"default": "I’m sorry, I didn’t understand. Ask about services, contact, hours, costs, founders, events, volunteering, or crisis support, or visit Contact. Time: 12:08 AM EAT, July 25, 2025."}
]
...
<div style='text-align: center; padding: 0.8rem; background: var(--primary); color: white;'>
    ...
    <p>Empowering Minds, Nurturing Hope Since 2023 | Updated: 12:08 AM EAT, July 25, 2025</p>
</div>
""", unsafe_allow_html=True)
...
if st.button("Log Mood"):
    ...
    st.success(f"Logged at 12:08 AM EAT, July 25, 2025!")
...
with st.form("volunteer_form", clear_on_submit=True):
    ...
    if submit:
        if not all([name, email, re.match(r"[^@]+@[^@]+\.[^@]+", email), phone, experience]):
            ...
            st.success(f"Thank you, {name}! Registered at 12:08 AM EAT, July 25, 2025. Contact at {email} within 48 hours.")
...
st.markdown("""
<div class='footer'>
    <p style='font-size: 0.9rem;'>© 2023-2025 SafeSpace Kenya | Designed with ❤️ | Updated: 12:08 AM EAT, July 25, 2025</p>
    <div style='display: flex; justify-content: center; gap: 0.5rem; flex-wrap: wrap;'>

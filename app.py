...
symptom_guide = {
    "Anxiety": {
        "physical": "Racing heart, sweating, trembling, dizziness",
        "emotional": "Excessive worry, fear of losing control, irritability",
        "coping": "Deep breathing, grounding exercises, scheduled worry time"
    },
    "Depression": {
        "physical": "Fatigue, sleep changes, appetite changes, aches",
        "emotional": "Persistent sadness, hopelessness, loss of interest",
        "coping": "Behavioral activation, light therapy, gratitude journaling"
    },
    "PTSD": {
        "physical": "Hypervigilance, insomnia, startle response",
        "emotional": "Flashbacks, nightmares, emotional numbness",
        "coping": "Grounding techniques, EMDR, creating safety plans"
    }
}
...
<div class='safe-container'>
    ...
    <div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1.2rem; margin: 2rem 0;'>
        <div class='mood-option' onclick='setMood("Radiant")'>
            <div class='mood-emoji'>😊</div>
            <div>Radiant</div>
            <div style='font-size: 0.85rem; color: #6c757d;'>Hopeful, joyful, energized</div>
        </div>
        <div class='mood-option' onclick='setMood("Calm")'>
            <div class='mood-emoji'>😌</div>
            <div>Calm</div>
            <div style='font-size: 0.85rem; color: #6c757d;'>Peaceful, centered, balanced</div>
        </div>
        <div class='mood-option' onclick='setMood("Neutral")'>
            <div class='mood-emoji'>😐</div>
            <div>Neutral</div>
            <div style='font-size: 0.85rem; color: #6c757d;'>Steady, indifferent, stable</div>
        </div>
        <div class='mood-option' onclick='setMood("Anxious")'>
            <div class='mood-emoji'>😟</div>
            <div>Anxious</div>
            <div style='font-size: 0.85rem; color: #6c757d;'>Worried, tense, overwhelmed</div>
        </div>
        <div class='mood-option' onclick='setMood("Sad")'>
            <div class='mood-emoji'>😔</div>
            <div>Sad</div>
            <div style='font-size: 0.85rem; color: #6c757d;'>Grieving, low, disconnected</div>
        </div>
    </div>
...
note = st.text_area("Journal your thoughts and experiences (optional)", 
                   height=140, 

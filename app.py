...
knowledge_base = [
    ...
    },
    {
        ...
        "answer": "Counseling at SafeSpace costs KSh 500-2,000 per session on a sliding scale based on income. Subsidies are available for low-income clients, and we offer free monthly workshops. Contact us at +254 781 095 919 or info@safespaceorganization.org for payment options like M-Pesa or bank transfer. Time: {time}."
    },
    {
    ...
    },
    {
        ...
        "answer": "SafeSpace Organization, founded in 2023 by Jerim Owino and Hamdi Roble, is a non-profit providing accessible mental health care in Kenya. We offer counseling for trauma, depression, and more, using CBT, EMDR, and mindfulness. Based in Nairobi, we serve 20+ districts. Contact us at info@safespaceorganization.org. Time: {time}."
    },
    {
        "keywords": ["contact safespace", "reach safespace", "safespace phone"],
        "answer": "Contact SafeSpace at +254 781 095 919 (8 AM-7 PM EAT, call or WhatsApp) or email info@safespaceorganization.org (24-hour response). Visit us at Greenhouse Plaza, Ngong Road, Nairobi. Time: {time}."
    },
    {
        "keywords": ["book appointment", "schedule counseling", "make appointment"],
        "answer": "Book a counseling session via the Book Appointment section on our website, call/WhatsApp +254 781 095 919 (8 AM-7 PM EAT), or email info@safespaceorganization.org. Provide your name, email, phone, preferred date, time, and counseling type. We’ll confirm within 48 hours. Time: {time}."
    },
    {
        "keywords": [],
        "answer": "I’m sorry, I didn’t understand your question. Try asking about counseling, services, costs, preparation, or how to book an appointment. You can also contact us at +254 781 095 919 or info@safespaceorganization.org. Time: {time}."
    }
]
...
with st.expander("Our Story and Impact", expanded=False):
    st.markdown("""
    - **Founded**: Launched after a 2022 Nakuru pilot supporting 50 clients.
...
with st.expander("More About Our Founders", expanded=False):
    ...
    - **Jerim Owino**: 
      ...
      - **Achievements**: Led SafeSpace’s 2022 Nakuru pilot, supporting 50 clients; received 2024 KCPA Innovation Award.
      - **Publications**: Co-authored “Trauma Recovery in Kenya” (2023).
      - **Vision**: Expand rural mental health access with mobile clinics by 2026.
    - **Hamdi Roble**: 
      ...
      - **Community Work**: Organized mental health awareness campaigns in Eldoret since 2017.
...
with st.expander("More About Events", expanded=False):
    ...
    - **Past Events**: June  occur within 48 hours of submission.
...
with st.expander("What to Expect When Booking", expanded=False):
    ...
    - **Rescheduling**: Contact info@safespaceorganization.org or WhatsApp +254 781 095 919.

...
services = [
    ("🧠", "Individual Counseling", "One-on-one sessions for mental health, trauma, stress, and anxiety."),
    ("👨‍👩‍👧", "Family Therapy", "Helps families improve communication and resolve conflicts together."),
    ("🧒", "Adolescent Therapy", "Support for teens facing academic, social, or emotional challenges."),
    ("💬", "Group Counseling", "Peer-based therapeutic discussions on specific topics."),
    ("🎨", "Art Therapy", "Creative therapy using visual art to explore emotions and healing."),
    ("🧕", "Faith-Sensitive Counseling", "Culturally respectful therapy aligned with your beliefs.")
]

...
<div style='text-align: center; padding: 4rem 2rem; background: linear-gradient(rgba(42,122,124,0.85), rgba(42,122,124,0.9)); border-radius: 10px; color: white;'>
    ...
    <img src='https://images.unsplash.com/photo-1588776814546-ec6fa1a3d221?auto=format&fit=crop&w=1000&q=80' style='width: 100%; border-radius: 10px; margin-top: 2rem;' />
</div>
...
with col2:
    st.image("https://images.unsplash.com/photo-1559757148-5c350d0d3c16?auto=format&fit=crop&w=1000&q=80", use_container_width=True)
...
services = [
    {
        ...
        "img": "https://images.unsplash.com/photo-1588776814546-ec6fa1a3d221?auto=format&fit=crop&w=800&q=80",
        "more": "Clients receive one-on-one counseling to process thoughts, feelings, trauma, or stress."
    },
    {
        "icon": "👥",
        "title": "Group Therapy",
        "desc": "Supportive group healing for grief, addiction, and stress.",
        "img": "https://images.unsplash.com/photo-1603201233684-2619f544f33a?auto=format&fit=crop&w=800&q=80",
        "more": "Group therapy helps people realize they're not alone while fostering shared experiences and healing."
    },
    {
        "icon": "🏠",
        "title": "Family Counseling",
        "desc": "Improve communication and resolve conflicts among family members.",
        "img": "https://images.unsplash.com/photo-1584467735871-b0dba6ac00f8?auto=format&fit=crop&w=800&q=80",
        "more": "We assist families in addressing issues such as parenting challenges, divorce, and blended family concerns."
    },
    {
        "icon": "🎓",
        "title": "Workshops & Training",
        "desc": "Programs for schools, companies, and community organizations.",
        "img": "https://images.unsplash.com/photo-1600195077073-36188f43f26f?auto=format&fit=crop&w=800&q=80",
        "more": "Workshops focus on emotional intelligence, stress management, team wellness, and mental health awareness."
    },
    {
        "icon": "📱",
        "title": "Tele-therapy",
        ...
        "more": "Ideal for clients outside Nairobi or those preferring remote support for privacy and flexibility."
    },
    {
        "icon": "❤️",
        "title": "Trauma Support",
        "desc": "Therapy for PTSD and trauma recovery.",
        "img": "https://images.unsplash.com/photo-1622519404523-02f6b5ba561b?auto=format&fit=crop&w=800&q=80",
        "more": "We help individuals who’ve experienced violence, abuse, loss, or other traumatic events heal and move forward."
    }
]
...
team = [
    {
        ...
        "img": "https://images.unsplash.com/photo-1614284212105-6e44b4a1fbd1?auto=format&fit=crop&w=400&q=80"
    },
    {
        "name": "Hamdi Roble",
    ...
    },
    {
        ...
        "img": "https://images.unsplash.com/photo-1614282169572-1b40d23f9c93?auto=format&fit=crop&w=400&q=80"
    }
]

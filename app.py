...
# CHATBOT SECTION (after all other sections)
...
knowledge_base = [
    ...
    {
        "section": "Team",
        "answer": "Our team includes Jerim Owino (Founder & CEO, trauma therapy expert), Hamdi Roble (Co-Founder, culturally-sensitive care advocate), Yvone Orina (Family Therapist), and Brian Kiprop (Art Therapist).",
        "keywords": ["team", "therapist", "jerim", "hamdi", "yvone", "brian", "founder"]
    },
    {

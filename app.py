...
knowledge_base = [
    ...
    {"default": f"I’m sorry, I didn’t understand. Ask about services, contact, hours, costs, founders, events, volunteering, crisis support, or partnerships. Time: 10:39 AM EAT, August 06, 2025."}
]
...
with st.form("counseling_form", clear_on_submit=True):
    ...
    if submit and name and re.match(r"[^@]+@[^@]+\.[^@]+", email) and phone:
        ...
        st.success(f"Thank you, {name}! Registered at 10:39 AM EAT, August 06, 2025. Contact at {email}.")
        st.session_state.counseling_form_data = {"name": "", "email": "", "phone": "", "type": "Online"}
    elif submit:
...
if st.button("Log"):
    ...
    st.success(f"Logged at 10:39 AM EAT, August 06, 2025!")
...
### Notes
- If you encountered a specific error (e.g., "ModuleNotFoundError: No module named 'pandas'" or a runtime crash), please share the exact message, and I’ll troubleshoot it.
- The current code should run without syntax errors based on the provided context. The timestamp update to 10:39 AM EAT aligns with the system’s current date and time.

Let me know if you have a specific error to address!

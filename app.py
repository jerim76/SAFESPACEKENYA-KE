...
knowledge_base = [
    {"question": r"what is safespace organization\??", "answer": "SafeSpace Organization, founded in 2023 by Jerim Owino and Hamdi Roble, is a non-profit dedicated to accessible mental health care, offering counseling for trauma, depression, and more, with a focus on inclusivity and support."},
    {"question": r"what services do you offer\??", "answer": "We provide Individual Counseling, Group Therapy, Family Counseling, Trauma Recovery Therapy, Online Counseling, and Youth Mentorship Programs, using evidence-based methods like CBT, EMDR, and mindfulness. Register in the Services section or WhatsApp us."},
    {"question": r"how can i contact you\??", "answer": "Reach us at +254 781 095 919 (8 AM-7 PM EAT) via call or WhatsApp, or email info@safespaceorganization.org (24-hour response). Visit us at Greenhouse Plaza, Ngong Road, Nairobi."},
    ...
    {"question": r"what events are coming up\??", "answer": "Join our Stress Management Workshop on July 30, 2025, in Nairobi, or Youth Mental Health Forum on August 15, 2025, in Kisumu. Register at events@safespaceorganization.org."},
    ...
    {"question": r"how can i partner with you\??", "answer": "Register as a Partner or Donor via the Partnerships form or contact partnership@safespaceorganization.org."},

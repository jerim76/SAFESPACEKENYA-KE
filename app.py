...
blogs = [
    {
        ...
        "date": "July 20, 2025",
        "desc": "Learn how to manage stress amid financial challenges with practical strategies."
    },
    {
        "title": "Cultural Perspectives on Therapy",
        "date": "July 15, 2025",
        "desc": "Discover how Kenyan traditions can enhance mental health support."
    }
]
cols = st.columns(2)
...
<div style='background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);'>
    ...
    <ul>
        ...
        <li><strong>Emergency Contact:</strong> +254 781 095 919</li>
        <li><strong>What to Do:</strong> Call a trusted person, contact our helpline, or visit the nearest hospital if in danger.</li>
    </ul>
...
<div style='background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);'>
    ...
    <div class='forum-card'>
        ...
        <p>Topic: Coping with Grief - Hosted by Hamdi Roble</p>
...
<div style='background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);'>
    ...
    <div class='tracker-card'>
        <h4>Mood Tracker</h4>
        <p>Rate your mood daily (1-5) and reflect on your progress.</p>
    </div>
    <a href='#contact' class='primary-btn' style='display: block; text-align: center; margin-top: 1rem;'>Start Tracking</a>
</div>
""", unsafe_allow_html=True)
...
volunteer_roles = [
    {
        ...
        "desc": "Assist with community awareness programs in Nairobi."
    },
    {
        "title": "Event Volunteer",
        "desc": "Help organize our upcoming Stress Management Workshop."
    }
]
cols = st.columns(2)
...
knowledge_base = [
    ...
    },
    {
        ...
        "answer": "Use our Progress Tracker to monitor your mood and therapy milestones with a simple daily rating tool.",

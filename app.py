...
# Custom CSS for enhanced styling including fixed icons
st.markdown("""
<style>
    :root {
        --primary: #26A69A;
...
# HEADER
st.markdown("""
<div style='text-align: center; padding: 1rem; background: var(--primary); color: white;'>
...
st.markdown("""
<div style='text-align: center; padding: 4rem 1rem; background: linear-gradient(rgba(38,166,154,0.9), rgba(77,182,172,0.9)); border-radius: 12px; color: white;'>
...
services = [
    {
        ...
        - **Read More**: Sessions are conducted by licensed therapists with experience in Kenyan cultural contexts, ensuring relevance and comfort. Contact us at info@safespacekenya.org for a detailed session plan or to schedule your first visit.
        """
    },
    {
        "icon": "👥",
        ...
        - **Read More**: Groups are limited to 10-12 participants for personalized attention. Join our next session by emailing outreach@safespacekenya.org for registration details.
        """
    },
    {
        "icon": "🏠",
        ...
        - **Read More**: Sessions include activities like role-playing to enhance understanding. Reach out to familycounseling@safespacekenya.org to book a family assessment.
        """
    },
    {
        "icon": "🎓",
        ...
        - **Read More**: Upcoming workshop on July 30, 2025, at 10:00 AM EAT. Register at https://safespacekenya.org/workshop-registration for more details and to secure your spot.
        """
    },
    {
        "icon": "📱",
        ...
        - **Read More**: Sessions are encrypted for privacy. Contact teletherapy@safespacekenya.org to set up your first virtual session.
        """
    },
    {
        "icon": "❤️",
        ...
        - **Read More**: Includes art therapy options. Email trauma.support@safespacekenya.org for a confidential consultation.
        """
    }
]
...
team = [
    {
        ...
        "read_more": """
        - **Background**: Holds a Master’s in Psychology from the University of Nairobi.
        - **Contact**: Email jerim@safespacekenya.org for leadership insights or collaboration.
        - **Achievements**: Pioneered Kenya’s first mobile trauma unit in 2024.
        """
    },
    {
        "name": "Hamdi Roble",
        ...
        "read_more": """
        - **Background**: Certified in Community Mental Health from JKUAT.
        - **Contact**: Reach Hamdi at hamdi@safespacekenya.org for outreach programs.
        - **Initiatives**: Launched the Rural Therapy Network in 2023.
        """
    }
]
...
for i, member in enumerate(team):
    with cols[i]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {member['name']}", expanded=False):
            st.markdown(member["read_more"])
...
resources = [
    {
        ...
        "read_more": """
        - **Benefits**: Reduces cortisol levels by up to 20% with regular practice.
        - **Usage**: Ideal for morning routines or before sleep.
        - **Download**: Available in multiple languages at https://safespacekenya.org/resources/breathing-guide.
        """
    },
    {
        ...
        "read_more": """
        - **Benefits**: Improves emotional clarity and reduces stress over time.
        - **Usage**: Spend 10-15 minutes daily for best results.
        - **Download**: Access the full prompt list at https://safespacekenya.org/resources/journaling-prompts.
        """
    },
    {
        ...
        "read_more": """
        - **Benefits**: Enhances focus and reduces anxiety by 15% in studies.
        - **Usage**: Listen daily via our audio file.
        - **Download**: Get it at https://safespacekenya.org/resources/mindfulness-audio.
        """
    }
]
cols = st.columns(3)
for i, resource in enumerate(resources):
    ...
    with cols[i % 3]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {resource['title']}", expanded=False):
            st.markdown(resource["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Resources Section", expanded=False):
    st.markdown("""
    - **Purpose**: Empower self-care at home.
    - **Updates**: New resources added quarterly.
    - **Contact**: Request tools at resources@safespacekenya.org.
    """)
...
""", unsafe_allow_html=True)
with st.expander("Read More About Crisis Resources", expanded=False):
    st.markdown("""
    - **Availability**: Helpline staffed by trained counselors.
    - **Support**: Includes follow-up calls if needed.
    - **Contact**: Email crisis.support@safespacekenya.org for resources.
    """)
...
blogs = [
    {
        ...
        "read_more": """
        - **Details**: Includes interviews with local experts on stress management techniques like the 4-7-8 breathing method.
        - **Author**: Written by Hamdi Roble, Co-Founder of SafeSpace Kenya.
        - **Access**: Full article available at https://safespacekenya.org/blog/stress-coping.
        """
    },
    {
        ...
        "read_more": """
        - **Details**: Explores case studies from rural Kenya where storytelling reduced anxiety by 30%.
        - **Author**: Contributed by Jerim Owino, Founder & CEO.
        - **Access**: Read the full piece at https://safespacekenya.org/blog/cultural-therapy.
        """
    }
]
cols = st.columns(2)
for i, blog in enumerate(blogs):
    with cols[i % 2]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {blog['title']}", expanded=False):
            st.markdown(blog["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Blog Section", expanded=False):
    st.markdown("""
    - **Purpose**: Offers ongoing education on mental health.
    - **Updates**: New articles posted monthly.
    - **Contact**: Suggest topics at blog@safespacekenya.org.
    """)
...
stories = [
    {
        ...
        "read_more": """
        - **Details**: Client completed 12 sessions over 3 months.
        - **Outcome**: Reported 40% improvement in anxiety scores.
        - **Contact**: Learn more by emailing success@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Details**: Involved 8 sessions with all family members.
        - **Outcome**: Enhanced family cohesion by 50% per follow-up.
        - **Contact**: Reach out to familycounseling@safespacekenya.org for similar support.
        """
    }
]
cols = st.columns(2)
for i, story in enumerate(stories):
    with cols[i % 2]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {story['title']}", expanded=False):
            st.markdown(story["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Success Stories", expanded=False):
    st.markdown("""
    - **Purpose**: Inspire hope through real experiences.
    - **Selection**: Stories chosen with client consent.
    - **Contact**: Share your story at success@safespacekenya.org.
    """)
...
events = [
    {
        ...
        "read_more": """
        - **Location**: Nairobi, Greenhouse Plaza.
        ...
        with st.form(f"event_form_{i}", clear_on_submit=True):
            ...
            if submit:
                if not name or not email or not re.match(r"[^@]+@[^@]+\.[^@]+", email) or not phone:
                    ...
                    st.success(f"Thank you, {name}! Your registration for {event['title']} has been received. We'll send a confirmation soon.")
                    st.session_state[f"event_form_data_{i}"] = {"name": "", "email": "", "phone": ""}
        with st.expander(f"Read More About {event['title']}", expanded=False):
            st.markdown(event["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Events Section", expanded=False):
    st.markdown("""
    - **Purpose**: Educate and support community mental health.
    - **Frequency**: Held monthly.
    - **Contact**: Event details at events@safespacekenya.org.
    """)
...
partnerships = [
    {
        ...
        "read_more": """
        - **Project**: Trauma relief camps since 2024.
        - **Impact**: Served over 500 individuals.
        - **Contact**: Details at https://safespacekenya.org/partnerships/redcross.
        """
    },
    {
        ...
        "read_more": """
        - **Project**: Annual school mental health program.
        - **Impact**: Reached 20 schools in 2025.
        - **Contact**: Info at https://safespacekenya.org/partnerships/education.
        """
    }
]
cols = st.columns(2)
for i, partnership in enumerate(partnerships):
    with cols[i % 2]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {partnership['name']}", expanded=False):
            st.markdown(partnership["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Partnerships Section", expanded=False):
    st.markdown("""
    - **Goal**: Expand reach through collaboration.
    - **Growth**: Adding new partners in 2026.
    - **Contact**: Partner with us at partnerships@safespacekenya.org.
    """)
...
testimonials = [
    {
        ...
        "read_more": """
        - **Session Details**: 10 sessions over 2 months.
        - **Therapist**: Assigned to Jerim Owino.
        - **Follow-Up**: Contact testimonials@safespacekenya.org for more stories.
        """
    },
    {
        ...
        "read_more": """
        - **Session Details**: 8 family sessions.
        - **Therapist**: Facilitated by Hamdi Roble.
        - **Follow-Up**: Email familycounseling@safespacekenya.org for support.
        """
    },
    {
        "name": "Aisha K., Kisumu",
        ...
        "read_more": """
        - **Session Details**: 12 sessions with faith integration.
        - **Therapist**: Hamdi Roble.
        - **Follow-Up**: Reach out at teletherapy@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Session Details**: 15 sessions including art therapy.
        - **Therapist**: Brian, trauma specialist.
        - **Follow-Up**: Contact trauma.support@safespacekenya.org.
        """
    }
]
...
for i, testimonial in enumerate(testimonials):
    with cols[i % 2]:
        ...
        """, unsafe_allow_html=True)
        with st.expander(f"Read More About {testimonial['name']}'s Experience", expanded=False):
            st.markdown(testimonial["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Testimonials Section", expanded=False):
    st.markdown("""
    - **Purpose**: Showcase real client success.
    - **Privacy**: All names anonymized with consent.
    - **Contact**: Submit testimonials at testimonials@safespacekenya.org.
    """)
...
faqs = [
    {
        ...
        "read_more": """
        - **Payment Options**: Installments available for packages.
        - **Discounts**: 10% off for students or first-time clients.
        - **Contact**: Email billing@safespacekenya.org for a quote.
        """
    },
    {
        ...
        "read_more": """
        - **Policy**: Aligned with Kenya Data Protection Act 2019.
        - **Details**: Information is encrypted and stored securely.
        - **Contact**: Privacy queries to privacy@safespacekenya.org.
        """
    },
    {
        ...
        - **Preparation**: Bring notes on your goals if desired.
        - **Contact**: Schedule at info@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Languages**: Includes Luo, Kikuyu, and Luhya.
        - **Request**: Specify language when booking.
        - **Contact**: Email multilingual@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Tips**: Write down 3 key concerns beforehand.
        - **Support**: Initial guidance provided in session.
        - **Contact**: Reach prep.support@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Helpline Hours**: 8 AM - 7 PM daily.
        - **Emergency**: Dial 999 if in immediate danger.
        - **Contact**: Crisis support at crisis@safespacekenya.org.
        """
    },
    {
        ...
        "read_more": """
        - **Future Plans**: Exploring insurance partnerships in 2026.
        - **Options**: Payment plans available.
        - **Contact**: Email billing@safespacekenya.org.
        """
    }
]
for faq in faqs:
    with st.expander(faq["question"]):
        ...
        with st.expander("Read More", expanded=False):
            st.markdown(faq["read_more"])
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About FAQ Section", expanded=False):
    st.markdown("""
    - **Purpose**: Address common client concerns.
    - **Updates**: FAQs reviewed quarterly.
    - **Contact**: Suggest questions at faq@safespacekenya.org.
    """)
...
st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Contact Section", expanded=False):
    st.markdown("""
    - **Purpose**: Facilitate easy communication.
    - **Support**: 24/7 email response available.
    - **Contact**: General inquiries at info@safespacekenya.org.
    """)
...
""", unsafe_allow_html=True)
with st.expander("Read More About Insights Section", expanded=False):
    st.markdown("""
    - **Purpose**: Provide actionable mental health tips.
    - **Sources**: Backed by clinical research.
    - **Contact**: Request topics at insights@safespacekenya.org.
    """)
...
""", unsafe_allow_html=True)
with st.expander("Read More About Community Forum", expanded=False):
    st.markdown("""
    - **Moderation**: Supervised by licensed therapists.
    - **Access**: Open to all registered users.
    - **Contact**: Join at forum@safespacekenya.org.
    """)
...
""", unsafe_allow_html=True)
with st.expander("Read More About Progress Tracker", expanded=False):
    st.markdown("""
    - **Features**: Tracks mood trends over weeks.
    - **Usage**: Accessible via your account dashboard.
    - **Contact**: Support at tracker@safespacekenya.org.
    """)
...
# Outreach Support Application Form
st.markdown("<h3>Apply for Outreach Support</h3>", unsafe_allow_html=True)
with st.form("outreach_form", clear_on_submit=True):
    name = st.text_input("Full Name", value=st.session_state.outreach_form_data["name"], placeholder="Your full name")
    email = st.text_input("Email", value=st.session_state.outreach_form_data["email"], placeholder="your.email@example.com")
    phone = st.text_input("Phone Number", value=st.session_state.outreach_form_data["phone"], placeholder="+254 XXX XXX XXX")
    experience = st.text_area("Relevant Experience (e.g., community work, public speaking)", value=st.session_state.outreach_form_data["experience"], placeholder="Describe your experience")
    skills = st.multiselect("Skills", ["Communication", "Public Speaking", "Event Planning", "Community Engagement"], default=st.session_state.outreach_form_data["skills"])
    submit_outreach = st.form_submit_button("Submit Application")
    if submit_outreach:
        if not name or not email or not re.match(r"[^@]+@[^@]+\.[^@]+", email) or not phone or not experience:
            st.error("Please fill in all required fields.")
        else:
            st.session_state.outreach_form_data = {"name": name, "email": email, "phone": phone, "experience": experience, "skills": skills}
            st.success("Thank you for applying! We'll review your application and contact you soon.")
            # Clear form data after successful submission
            st.session_state.outreach_form_data = {"name": "", "email": "", "phone": "", "experience": "", "skills": []}

st.markdown("</div>", unsafe_allow_html=True)
with st.expander("Read More About Volunteer Opportunities", expanded=False):
    st.markdown("""
    - **Training**: Provided free by our team.
    - **Impact**: Volunteers reach over 1000 people annually.
    - **Contact**: Apply at volunteer@safespacekenya.org.
    """)

# Event Volunteer Application Form
st.markdown("<h3>Apply for Event Volunteer</h3>", unsafe_allow_html=True)
with st.form("event_form", clear_on_submit=True):
    name = st.text_input("Full Name", value=st.session_state.event_form_data["name"], placeholder="Your full name")
    email = st.text_input("Email", value=st.session_state.event_form_data["email"], placeholder="your.email@example.com")
    phone = st.text_input("Phone Number", value=st.session_state.event_form_data["phone"], placeholder="+254 XXX XXX XXX")
    experience = st.text_area("Relevant Experience (e.g., event management, logistics)", value=st.session_state.event_form_data["experience"], placeholder="Describe your experience")
    skills = st.multiselect("Skills", ["Event Coordination", "Logistics", "Teamwork", "Customer Service"], default=st.session_state.event_form_data["skills"])
    submit_event = st.form_submit_button("Submit Application")
    if submit_event:
        if not name or not email or not re.match(r"[^@]+@[^@]+\.[^@]+", email) or not phone or not experience:
            st.error("Please fill in all required fields.")
        else:
            st.session_state.event_form_data = {"name": name, "email": email, "phone": phone, "experience": experience, "skills": skills}
            st.success("Thank you for applying! We'll review your application and contact you soon.")
            # Clear form data after successful submission
            st.session_state.event_form_data = {"name": "", "email": "", "phone": "", "experience": "", "skills": []}
...
# CHATBOT (Moved to the last part)
st.markdown("""

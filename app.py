...
events = [
    {
        ...
        - **Registration**: Sign up at https://safespacekenya.org/workshop-registration.
        """
    },
    {
        ...
        - **Registration**: Register at https://safespacekenya.org/webinar-registration.
        """
    }
]
cols = st.columns(2)
for i, event in enumerate(events):
    with cols[i % 2]:
        ...
        <div class='event-card'>
            ...
            <p>{event['desc']}</p>
            <a href='{event["read_more"].split("\n")[2].split(": ")[1]}' class='primary-btn' style='display: block; text-align: center; margin-top: 1rem;'>Register</a>
        </div>
        """, unsafe_allow_html=True)

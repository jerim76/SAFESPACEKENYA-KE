...
<style>
    ...
    h2 { font-size: 2.2rem; }
    h3 { font-size: 1.8rem; }
    .service-card, .team-card, .testimonial-card, .cta-banner, .insights-content, .chatbot-container {
        background: white;
        padding: 1.5rem;
        border-radius: 12px;
    ...
    @media (max-width: 768px) {
        ...
        .service-card, .team-card, .testimonial-card, .insights-content, .chatbot-container {
            margin: 0.5rem;
        }
        .chatbot-container {
            width: 90%;
...
team = [
    {
        ...
        "img": "https://images.unsplash.com/photo-1597227774096-1a1a9f9b0a34?auto=format&fit=crop&w=400&q=80"
    },
    {
        "name": "Hamdi Roble",
        "role": "Co-Founder",
        "bio": "Co-Founder passionate about culturally-sensitive mental health care and community outreach.",
        "img": "https://images.unsplash.com/photo-1596484558489-4cdcd8f1d5b6?auto=format&fit=crop&w=400&q=80"
    }
]
...
testimonials = [
    {
        ...
        "img": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=100&q=80"
    },
    {
        ...
        "img": "https://images.unsplash.com/photo-1611432579699-5f11d2e1c1d1?auto=format&fit=crop&w=100&q=80"
    },
    {
        "name": "Aisha K., Kisumu",
        ...
        "img": "https://images.unsplash.com/photo-1607746882042-9446351c901e?auto=format&fit=crop&w=100&q=80"
    },
    {
        ...
        "img": "https://images.unsplash.com/photo-1600585153490-2e4d26b0c7b0?auto=format&fit=crop&w=100&q=80"
    }
]
...
# CHATBOT SECTION (after all sections)
...
knowledge_base = [
    ...
    {
        "section": "Team",
        "answer": "Our team includes Jerim Owino (Founder & CEO, trauma therapy expert) and Hamdi Roble (Co-Founder, culturally-sensitive care advocate).",
...
# Chatbot at bottom left, after all sections
st.markdown("""
...
# Display chat history below chatbot title

...
def get_download_link(file_content, file_name):
    ...
    href = f'<a href="data:application/octet-stream;base64,{b64}" download="{file_name}">Download</a>'
    return href
...
for i, resource in enumerate(resources):
    ...
    with cols[i % 3]:
        ...
        <div class='resource-card'>
            ...
            <p>{resource['desc']}</p>
            <a href="{download_link}" class='primary-btn' download style='display: block; text-align: center; margin-top: 1rem;'>Download</a>
        </div>
        """, unsafe_allow_html=True)

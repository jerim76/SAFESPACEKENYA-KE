...
team_data = [
    {
        "name": "Jerim Owino", 
        "role": "Founder & CEO", 
        "bio": "Clinical psychologist specializing in trauma therapy with 12 years of experience.",
    ...
    },
    {
        ...
        "bio": "Muslim therapist specializing in culturally-sensitive CBT for anxiety and depression.",
    ...
    },
    {
        "name": "Brian Kiprop", 
        "role": "Art Therapist", 
        "bio": "Uses creative approaches to help clients express emotions.",
...
def home_page():
    ...
    with testimonial_cols[0]:
        st.markdown("""
        <div style="border-radius: 10px; padding: 1.5rem; background: white; 
                    box-shadow: 0 4px 6px rgba(0,0,0,0.1); height: 300px;">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1rem;">
                ...
                <div>
                    <h4 style="margin: 0;">Wanjiru M., Nairobi</h4>
                </div>
            </div>
            <p style="font-style: italic;">"Safe Space Kenya provided me with the tools to manage my anxiety in a way that respected my cultural background."</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div style="border-radius: 10px; padding: 1.5rem; background: white; 
            ...
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1rem;">
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" 
                     style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">
                <div>
                    <h4 style="margin: 0;">David O., Mombasa</h4>
                </div>
            </div>
            <p style="font-style: italic;">"The family counseling sessions helped us rebuild communication after a difficult period. Our family is stronger now."</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 2rem; margin-bottom: 2rem;">
        ...
        <div>
            ...
            <div style="display: flex; margin-top: 1rem;">
                ...
                <button onclick="subscribeNewsletter()" class="primary-btn" 
                        style="border-radius: 0 4px 4px 0; padding: 0.5rem 1rem; cursor: pointer;">→</button>
            </div>
            <p id="newsletter-message" style="margin-top: 0.5rem; color: #2a7a7c; font-size: 0.9rem;"></p>
        </div>
    </div>
    ...
    function subscribeNewsletter() {
        ...
        messageElement.style.color = '#2a7a7c';

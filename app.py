...
knowledge_base = [
    {
        ...
        "answer": "Counseling is a professional process where a trained therapist helps you address emotional, mental, or behavioral challenges in a safe, confidential space. At SafeSpace Organization, we offer counseling to manage issues like anxiety, depression, trauma, or relationship problems using evidence-based methods like CBT and EMDR. Sessions are tailored to your needs, helping you gain coping skills and improve wellbeing. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["how does counseling work", "what happens in counseling", "counseling session"],
        "answer": "In a counseling session, you’ll meet with a therapist to discuss your concerns, set goals, and explore solutions. Sessions last 50-90 minutes, starting with a 15-minute consultation to match you with the right therapist. Expect talk therapy, exercises (e.g., journaling), or techniques like mindfulness. Our therapists use CBT, EMDR, or DBT to guide you. Progress is tracked weekly, and 85% of clients report improvement after 8 sessions. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["what is cbt", "cognitive behavioral therapy", "cbt work"],
        "answer": "Cognitive Behavioral Therapy (CBT) is a therapy that helps you identify and change negative thought patterns affecting your emotions and behavior. It’s effective for anxiety, depression, and PTSD. At SafeSpace, CBT involves structured 50-minute sessions with exercises like thought records or relaxation techniques. Clients learn coping skills, with 80% seeing mood improvement after 6-8 sessions. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["what is emdr", "eye movement desensitization", "emdr therapy"],
        "answer": "Eye Movement Desensitization and Reprocessing (EMDR) is a therapy for trauma, helping you process distressing memories. It uses guided eye movements to reduce emotional triggers. At SafeSpace, 75-minute EMDR sessions are led by certified therapists for issues like abuse or accidents. 88% of clients report reduced triggers after 10 sessions. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["cost of counseling", "how much counseling", "counseling fees"],
        "answer": "Counseling at SafeSpace costs as low as KSh 2,000 per session, with subsidies available for low-income clients. We also offer free monthly workshops. Contact us at +254758943430 or owinojerim269@gmail.com for payment options like M-Pesa or bank transfer. Time: {time}."
    },
    {
        "keywords": ["prepare for counseling", "get ready for session", "counseling preparation"],
        "answer": "To prepare for counseling, reflect on your goals (e.g., managing anxiety), bring any medical or mental health history, and arrive 5-10 minutes early. For online sessions, ensure a stable internet connection and a private space. Our therapists will guide you through the rest. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["therapist qualifications", "counselor credentials", "therapist trained"],
        "answer": "Our therapists at SafeSpace hold Master’s degrees or higher in psychology or counseling, with certifications in CBT, EMDR, DBT, and other therapies. They average 10+ years of experience and are registered with the Kenya Counseling and Psychological Association (KCPA). Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["individual counseling", "one on one counseling", "personal therapy"],
        "answer": "Individual Counseling at SafeSpace offers 50-minute one-on-one sessions for issues like depression, anxiety, PTSD, or OCD. Using CBT, DBT, or ACT, therapists create personalized plans with weekly progress tracking. Available in-person or online, starting at KSh 2,000 per session. 85% of clients report better mood after 8 sessions. Book via our website, WhatsApp +254758943430, or email owinojerim269@gmail.com. Time: {time}."
    },
    {
        "keywords": ["group therapy", "group counseling", "support group"],
        "answer": "Group Therapy involves 90-minute weekly sessions for 8-10 people, focusing on grief, addiction, or anxiety. Led by two counselors, it includes peer support and mindfulness exercises. Available in-person or online, starting at KSh 2,000 per session, with a 3-month commitment recommended. 80% of participants feel less isolated after 6 sessions. Register at #services, WhatsApp +254758943430, or email owinojerim269@gmail.com. Time: {time}."
    },
    {
        "keywords": ["youth mentorship", "teen counseling", "youth program"],
        "answer": "Our Youth Mentorship Program supports ages 13-25 with 60-minute biweekly sessions addressing self-esteem, peer pressure, or academic stress. Using art therapy, CBT, and peer support, it includes group workshops and one-on-one mentoring. Available in-person or online, starting at KSh 2,000 per session. 95% of youth report increased confidence after 3 months. Contact us at +254758943430 or owinojerim269@gmail.com. Time: {time}."
    },
    {
        "keywords": ["confidential", "counseling privacy", "is counseling safe"],
        "answer": "Yes, counseling at SafeSpace is fully confidential. We use encrypted platforms for online sessions and follow strict privacy protocols. Your information is only shared with your consent or in emergencies, per KCPA guidelines. Time: {time}. For bookings, contact us at +254758943430 or owinojerim269@gmail.com."
    },
    {
        "keywords": ["safespace organization", "about safespace", "who is safespace"],
        "answer": "SafeSpace Organization, founded in 2023 by Jerim Owino and Hamdi Roble, is a non-profit providing accessible mental health care in Kenya. We offer counseling for trauma, depression, and more, using CBT, EMDR, and mindfulness. Contact us at owinojerim269@gmail.com. Time: {time}."
    },
    {
        "keywords": ["contact safespace", "reach safespace", "safespace phone"],
        "answer": "Contact SafeSpace at +254758943430 (8 AM-7 PM EAT, call or WhatsApp) or email owinojerim269@gmail.com (24-hour response). Visit us at Greenhouse Plaza, Ngong Road, Nairobi. Time: {time}."
    },
    {
        "keywords": ["book appointment", "schedule counseling", "make appointment"],
        "answer": "Book a counseling session via the Book Appointment section on our website, call/WhatsApp +254758943430, or email owinojerim269@gmail.com. Provide your name, email, phone, preferred date, time, and counseling type. We’ll confirm within 48 hours. Time: {time}."
    },
    {
        "keywords": [],
        "answer": "I’m sorry, I didn’t understand your question. Try asking about counseling, services, costs, preparation, or how to book an appointment. You can also contact us at +254758943430 or owinojerim269@gmail.com. Time: {time}."
    }
]
...
def get_chatbot_response(query):
    try:
        ...
        return f"Sorry, an error occurred: {str(e)}. Please try again or contact us at +254758943430 or owinojerim269@gmail.com. Time: {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')}"
...
with st.expander("Why Choose SafeSpace Organization?", expanded=False):
    ...
    - **Accessibility**: Affordable sessions starting at KSh 2,000, online options, and support in multiple languages.
...
st.markdown("""
<div style='background: var(--white); padding: 1rem; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);'>
    <p style='font-size: 1.2rem;'>Our team of 15 certified therapists, with over 75 years of combined experience, offers tailored counseling starting at KSh 2,000 per session. Each service includes a free 15-minute consultation to ensure the right fit, with sessions available in-person in Nairobi, Kisumu, and Eldoret or online via secure platforms. Subsidies are available for low-income clients.</p>
</div>
""", unsafe_allow_html=True)
services = [
    {
...
with st.form("counseling_form", clear_on_submit=True):
    ...
    if submit:
        if not all([name, email, re.match(r"[^@]+@[^@]+\.[^@]+", email), phone]):
            ...
            st.success(f"Thank you, {name}! Your {counseling_type} counseling registration at {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')} is received. We’ve notified our team at +254758943430 and owinojerim269@gmail.com. We’ll contact you at {email} within 48 hours.")
            st.session_state.counseling_form_data = {"name": "", "email": "", "phone": "", "type": "Online"}
...
with st.expander("What to Expect from Our Services", expanded=False):
    ...
    - **Affordability**: Sessions starting at KSh 2,000, with subsidies for low-income clients and free monthly workshops.
...
with st.form("volunteer_form", clear_on_submit=True):
    ...
    if submit:
        if not all([name, email, re.match(r"[^@]+@[^@]+\.[^@]+", email), phone, experience]):
            ...
            st.success(f"Thank you, {name}! Your registration for {role_preference} at {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')} is received. We’ve notified our team at +254758943430 and owinojerim269@gmail.com. We’ll contact you at {email} within 48 hours.")
...
with st.form("partnership_form", clear_on_submit=True):
    ...
    if submit:
        if not all([name, email, re.match(r"[^@]+@[^@]+\.[^@]+", email), phone]):
            ...
            st.success(f"Thank you, {name}! Your {partnership_type} registration at {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')} is received. We’ve notified our team at +254758943430 and owinojerim269@gmail.com. We’ll contact you at {email} within 48 hours.")
            st.session_state.partnership_form_data = {"name": "", "organization": "", "email": "", "phone": "", "type": "Partner"}
...
<div style='background: var(--white); padding: 1rem; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);'>
    ...
    <ul>
        ...
        <li><strong>Financial Aid</strong>: Sessions starting at KSh 2,000 with subsidies for low-income clients.</li>
    </ul>
    <div style='text-align: center; margin-top: 1rem;'>
...
with st.form("appointment_form", clear_on_submit=True):
    ...
    if submit:
        if not all([name, email, re.match(r"[^@]+@[^@]+\.[^@]+", email), phone, preferred_date, preferred_time]):
            ...
            st.success(f"Thank you, {name}! Your {counseling_type} appointment request for {preferred_date.strftime('%B %d, %Y')} at {preferred_time.strftime('%I:%M %p')} has been received at {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')}. We’ve notified our team at +254758943430 and owinojerim269@gmail.com. We’ll contact you at {email} within 48 hours to confirm.")
            st.session_state.appointment_form_data = {"name": "", "email": "", "phone": "", "date": "", "time": "", "type": "Online"}
...
with st.expander("What to Expect When Booking", expanded=False):
    ...
    - **Rescheduling**: Contact owinojerim269@gmail.com or WhatsApp +254758943430.
...
<div style='background: var(--white); padding: 1rem; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);'>
    ...
    <p><strong>Q: How do I pay?</strong> A: Cash, M-Pesa, or bank transfer; sessions start at KSh 2,000 with subsidies available.</p>
    <p><strong>Q: How do I book?</strong> A: Use the Book Appointment form, call, or WhatsApp +254758943430, or email owinojerim269@gmail.com.</p>
...
<div style='background: var(--white); padding: 1rem; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.1);'>
    ...
    <p><strong>✉️</strong> <a href='mailto:owinojerim269@gmail.com'>owinojerim269@gmail.com</a>, 24-hour response.</p>
...
with st.form("chat_form", clear_on_submit=True):
    user_input = st.text_input("Ask a question...", placeholder="e.g., What is counseling? How do I book a session?", key="chat_input")
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (whatsappToggle && whatsappWidget) {
            whatsappToggle.addEventListener('click', function() {
                if (whatsappWidget.style.display === 'none' || !whatsappWidget.style.display) {
...
with st.form("newsletter_form", clear_on_submit=True):
    ...
    if submit_newsletter:
        if not newsletter_email or not re.match(r"[^@]+@[^@]+\.[^@]+", newsletter_email):
            ...
            st.success(f"Subscribed! Next newsletter: August 1, 2025, 9 AM EAT. Notification sent to +254758943430 and owinojerim269@gmail.com.")

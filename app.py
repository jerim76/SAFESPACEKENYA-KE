...
services = [
    ("🧠", "Individual Counseling", "Private one-on-one therapy sessions with licensed counselors to address anxiety, depression, trauma, and life transitions. Learn coping mechanisms tailored to your personal experiences."),
    ("👨‍👩‍👧", "Family Therapy", "Collaborative sessions that help family members resolve conflicts, improve communication, and build stronger relationships in a safe space."),
    ("🧒", "Adolescent Therapy", "Support and guidance for teenagers facing peer pressure, academic stress, identity issues, and behavioral challenges."),
    ("💬", "Group Counseling", "Group therapy for those who benefit from shared experiences, fostering community healing for grief, addiction, trauma, or other themes."),
    ("🎨", "Art Therapy", "Expressive therapy that encourages creativity to help clients explore their feelings, develop self-awareness, and cope with stress and trauma."),
    ("🧕", "Faith-Sensitive Counseling", "Supportive mental health services tailored to clients' spiritual and cultural beliefs, respecting religious values in therapy."),
    ("📱", "Online Counseling", "Convenient and confidential virtual sessions via phone or video call. Ideal for clients with mobility challenges or remote locations.")
]
...
for i, tab in enumerate(tabs):
    with tab:
        ...
        if st.button(f"Learn More about {services[i][1]}", key=i):
            st.info(f"More details about {services[i][1]} coming soon...")

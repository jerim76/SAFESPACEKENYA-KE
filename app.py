...
knowledge_base = [
    ...
    {"default": f"I’m sorry, I didn’t understand. Ask about services, contact, hours, costs, founders, events, volunteering, crisis support, or partnerships, or visit Contact. Time: {datetime.now().strftime('%I:%M %p EAT, %B %d, %Y')}."}
]

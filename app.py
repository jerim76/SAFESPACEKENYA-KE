...
knowledge_base = [
    ...
    {"default": "I’m sorry, I didn’t understand. Ask about services, contact, hours, costs, founders, events, volunteering, crisis support, partnerships, or resources, or visit Contact. Time: 06:46 PM EAT, August 05, 2025."}
]
...
services = [
    ...
    },
    {
        ...
        "desc": "Offers virtual therapy sessions for individuals facing barriers to in-person care, addressing conditions such as anxiety, depression, and stress (panic attacks, sleep issues, overwhelm). Delivered by licensed therapists via secure video platforms, each 50-minute session utilizes CBT, mindfulness, and teletherapy techniques
